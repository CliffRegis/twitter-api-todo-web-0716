...
# my_twitter_api_instance = TwitterApi.new
# # automatically, for us, the #initialize method will be run
# my_twitter_api_instance.client 
# my_twitter_api_instance.name

# sophies_best_instance = TwitterApi.new
